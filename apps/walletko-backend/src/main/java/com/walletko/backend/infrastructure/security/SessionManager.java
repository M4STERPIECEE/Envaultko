...
import com.walletko.backend.infrastructure.persistence.entity.UserEntity;
import com.walletko.backend.infrastructure.persistence.repository.SessionJpaRepository;
...
public class SessionManager {
    private static final String COOKIE_NAME = "walletko_session";
    ...
    public SessionManager(SessionJpaRepository sessionRepo,
                           ...
                           @Value("${walletko.auth.otp.expiry-seconds:300}") long expirySeconds) {
