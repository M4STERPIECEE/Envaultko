...
import com.envaultko.backend.domain.pot.TransferData;
...
import com.envaultko.backend.infrastructure.persistence.entity.TransactionTagEntity;
...
public abstract class TransactionMapper {
    ...
    @Mapping(target = "createdAt",             source = "createdAt")
    @Mapping(target = "updatedAt",             source = "createdAt")
    public abstract TransactionEntity toJpa(com.envaultko.backend.domain.income.CancellationData d);
