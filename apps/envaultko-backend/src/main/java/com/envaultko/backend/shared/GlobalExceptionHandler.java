package com.envaultko.backend.shared;

import com.envaultko.backend.application.auth.InvalidOtpError;
import com.envaultko.backend.domain.income.CancelIncomeBlockedError;
import com.envaultko.backend.domain.savedview.SavedViewNameConflictError;
import com.envaultko.backend.domain.tag.TagNameConflictError;
