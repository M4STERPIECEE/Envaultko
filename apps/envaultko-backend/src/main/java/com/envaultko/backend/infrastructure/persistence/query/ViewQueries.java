package com.envaultko.backend.infrastructure.persistence.query;

import com.envaultko.backend.application.savedview.ViewQuery;
import com.envaultko.backend.infrastructure.persistence.repository.*;
import com.envaultko.backend.interfaces.dto.*;
...
public class ViewQueries implements ViewQuery {
    ...
    private List<com.envaultko.backend.infrastructure.persistence.entity.TransactionEntity> filterTransactions(
            List<com.envaultko.backend.infrastructure.persistence.entity.TransactionEntity> txs,
            String nameFilter, List<String> tagIds) {
