...
import com.envaultko.backend.infrastructure.mail.SmtpMailer;
import com.envaultko.backend.infrastructure.persistence.entity.VerificationEntity;
import com.envaultko.backend.infrastructure.persistence.repository.VerificationJpaRepository;
...
public class OtpService {
    ...
    public OtpService(VerificationJpaRepository verificationRepo,
                      SmtpMailer mailer,
                      @Value("${envaultko.auth.otp.length}") int otpLength,
                      @Value("${envaultko.auth.otp.expiry-seconds}") long expirySeconds,
                      @Value("${envaultko.auth.otp.max-attempts}") int maxAttempts) {
