...
![Envaultko dashboard showing pot balances, monthly totals, and a yearly income/expense chart](preview.png)

A bank account merges everything into one number, and that number is a lie — part of it is rent, part is savings you promised not to touch, part is genuinely free. Envaultko puts the envelopes back.
